...
export const UploadView: React.FC<UploadViewProps> = ({
  ...
  return (
    <div className="flex-1 w-full bg-gradient-to-b from-white via-white to-slate-100/60 rounded-2xl border border-slate-200/70 p-8 flex flex-col items-center justify-center relative overflow-hidden select-none">
      {/* Hidden File Inputs */}
      <input
        type="file"
        ref={qpInputRef}
